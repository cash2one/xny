...
@Component({
  ...
  styleUrls: [
    ...
    './department-create.component.scss'
  ]
})
export class DepartmentCreateComponent implements OnInit {
  ...
  constructor(
    ...
    this.departmentAdmin  = ''
  	this.callData = new EventEmitter<{type:string,symbol:boolean,data:any}>()
  }

  ngOnInit() {
  	this.getSetDepatmentEmit()
    this.getSetAdminEmit()
    this.postCreateEditData.cid = this.routerInfo.cid
  }
  ...
  public fnGetDepartmentInfo():void{
    ...
    this.grMembersService.postDepartmentInfo({
