...
export class AssistAddEditClassifyComponent implements OnInit {
  ...
  constructor(
    ...
    this.parentRX$ = this.classifyParentService.getSubject().subscribe(res=>{
      ...
      this.classifyObj['parentid'] = res['id']
    })
  ...
  ngOnChanges(changes: SimpleChanges) {
    if(this.TYPE) {
      this.classifyObj = this.TYPE == 'EDIT' ? (()=>{
        ...
        return {
          ...(new classifyObj()),
          'parentid': this.menuEditData['id']
        }
      })()
      this.parentName = this.handleFindParentData(this.classifyObj['parentid'])
    }
  ...
  public parentEmitData(event: ElementRef) : void{
    this.parentPbox.emit({
      'el': event,
      'data': this.classifyObj['parentid']
    })
  }
  ...
  public postAddClassify() : void{
    ...
    this.grAssistService.postHelpcatAdd( {...this.classifyObj} ).subscribe( res=> {  
  ...
  public postEditClassify() : void{
    ...
    this.grAssistService.postHelpcatEdit( {...this.classifyObj} ).subscribe( res=> {  
