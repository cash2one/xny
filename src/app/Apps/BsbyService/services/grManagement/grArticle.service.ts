...
export class GrArticleService {
    ...
    //-------post--------//
    //添加文章
    private articleAdd = this.httpURL + '/api/bsby/service/article/add'
    //修改 文章
    private articleEdit = this.httpURL + '/api/bsby/service/article/edit'
    //删除 文章
    private articleDel = this.httpURL + 'api/bsby/service/article/del'

    //------get--------//
    //文章列表
    private articleList = this.httpURL + '/api/bsby/service/article/list'
