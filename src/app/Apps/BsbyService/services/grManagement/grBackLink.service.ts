...
export class GrBackLinkService {
    ...
    //-------post--------//
    //添加外链
    private backlinkAdd = this.httpURL + '/api/bsby/service/backlink/add'
    //修改外链
    private backlinkEdit = this.httpURL + '/api/bsby/service/backlink/edit'
    //删除外链
    private backlinkDel = this.httpURL + 'api/bsby/service/backlink/del'

    //------get--------//
    //外链列表
    private backlinkList = this.httpURL + '/api/bsby/service/backlink/list'
