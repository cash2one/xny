...
export class GrFriendLinkService {
    ...
    //-------post--------//
    //添加友链
    private friendlinkAdd = this.httpURL + '/api/bsby/service/friendlink/add'
    //修改友链
    private friendlinkEdit = this.httpURL + '/api/bsby/service/friendlink/edit'
    //删除友链
    private friendlinkDel = this.httpURL + 'api/bsby/service/friendlink/del'

    //------get--------//
    //友链列表
    private friendlinkList = this.httpURL + '/api/bsby/service/friendlink/list'
