...
@Component({
  selector: 'app-write-writing',
  templateUrl: './write-writing.component.html',
  styleUrls: ['./write-writing.component.scss']
})
export class WriteWritingComponent implements OnInit {
