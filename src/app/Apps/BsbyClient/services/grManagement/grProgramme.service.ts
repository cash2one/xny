...
export class GrProgrammeService {
    ...
    // ---- get ---- //
    //方案列表
    private programmeList = this.httpURL + 'api/bsby/client/programme/list'
    //添加方案
    private programmeAdd = this.httpURL + 'api/bsby/client/programme/add'
    //编辑方案
    private programmeEdit = this.httpURL + 'api/bsby/client/programme/edit'
    //删除方案
    private programmeDel = this.httpURL + 'api/bsby/client/programme/del'
    //方案详情
    private programmeInfo = this.httpURL + 'api/bsby/client/programme/info'
