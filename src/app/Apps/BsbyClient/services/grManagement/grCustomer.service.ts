...
export class GrCustomerService {
    ...
    //-------post--------//
    //添加客户
    private customerAdd = this.httpURL + 'api/bsby/client/customer/add'
    //修改客户
    private customerEdit = this.httpURL + 'api/bsby/client/customer/edit'
    //删除客户
    private customerDel = this.httpURL + 'api/bsby/client/customer/del'

    //------get--------//
    //客户列表
    private customerList = this.httpURL + 'api/bsby/client/customer/list'
    //客户信息
    private customerInfo = this.httpURL + 'api/bsby/client/customer/info'
