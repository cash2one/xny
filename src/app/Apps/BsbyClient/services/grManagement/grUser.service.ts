...
export class GrUserService {
    ...
    //------get--------//
    //应用成员列表
    private userList = this.httpURL + 'api/bsby/client/user/list'
    //场景-执行人员
    private excList = this.httpURL + 'api/bsby/client/user/executor'
    //场景-客服人员
    private serviceList = this.httpURL + 'api/bsby/client/user/service'
