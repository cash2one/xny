...
export class GrSiteService {
    ...
    // ----- get ------ //
    //网站列表
    private siteList = this.httpURL + 'api/bsby/client/site/list'
    //网站详情
    private siteInfo = this.httpURL + 'api/bsby/client/site/info'
    //网站角色列表
    private siteRoleList = this.httpURL + 'api/bsby/client/site/role_list'
    //网站描述信息更新
    private siteDescInfo = this.httpURL + 'api/bsby/service/site/basic_auto'

    // ----- post ----- //
    //添加网站
    private siteAdd = this.httpURL + 'api/bsby/client/site/add'
    //添加角色
    private siteRoleAdd = this.httpURL + 'api/bsby/client/site/role_add'
    //删除角色
    private siteRoleDel = this.httpURL + 'api/bsby/client/site/role_del'
    //角色排序
    private siteRoleOrder = this.httpURL + 'api/bsby/client/site/role_order'
    //角色设置
    private siteRoleSet = this.httpURL + 'api/bsby/client/site/role_set'
    //编辑账号信息
    private siteAccount = this.httpURL + 'api/bsby/client/site/account'
    //编辑服务信息
    private siteService = this.httpURL + 'api/bsby/client/site/service'
    //修改网站状态
    private siteStatus = this.httpURL + 'api/bsby/client/site/status'
     ...
     */
    public getSiteList(obj:any):Observable<any>{
        return this.appService.interfaceJudg('post',this.siteList,obj)
    }
