...
export class GrKeywordService {
    ...
    // ----- get ----- //
    //关键字列表
    private keywordList = this.httpURL + 'api/bsby/client/keyword/list'
    // ----- post ---- //
    //添加关键字
    private keywordAdd = this.httpURL + 'api/bsby/client/keyword/add'
    //修改关键字
    private keywordEdit = this.httpURL + 'api/bsby/client/keyword/edit'
    //删除关键字
    private keywordDel = this.httpURL + 'api/bsby/client/keyword/del'
    //修改关键字状态
    private keywordStatus = this.httpURL + 'api/bsby/client/keyword/status'
    //关键词明细
    private keywordLog = this.httpURL + 'api/bsby/client/keyword/log'
    //关键字趋势
    private keywordInfo = this.httpURL + 'api/bsby/client/keyword/info'
