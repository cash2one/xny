...
export class GrProductService {
    ...
    // ------- get -------  //
    //产品列表
    private productList = this.httpURL + 'api/bsby/client/product/list'

    // -------post ------ //
    //添加产品
    private productAdd = this.httpURL + 'api/bsby/client/product/add'
    //编辑产品
    private productEdit = this.httpURL + 'api/bsby/client/product/edit'
    //产品状态
    private productStatus = this.httpURL + 'api/bsby/client/product/status'
    //删除产品
    private productDel = this.httpURL + 'api/bsby/client/product/del'
