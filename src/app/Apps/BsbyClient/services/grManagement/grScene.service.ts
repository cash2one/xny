...
export class GrSceneService {
    ...
    //------get--------//
    //场景列表
    private sceneList = this.httpURL + 'api/bsby/client/scene/list'
    //场景信息
    private sceneInfo = this.httpURL + 'api/bsby/client/scene/info'

    // -----post------//
    //添加场景
    private sceneAdd = this.httpURL + 'api/bsby/client/scene/add'
    //编辑场景
    private sceneEdit = this.httpURL + 'api/bsby/client/scene/edit'
    //删除场景
    private sceneDel = this.httpURL + 'api/bsby/client/scene/del'
     ...
     * type 3
     */
    public getSceneList():Observable<any>{
        return this.appService.interfaceJudg('get',this.sceneList,{
            type:3
        })
    }
